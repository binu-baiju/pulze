...
const App: React.FunctionComponent = () => {
  return (
    <>
      ...
      <div classNameName="container relative hidden h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <Link
          href="/signup"
          classNameName={cn(
        ...
        <div classNameName="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div classNameName="relative z-20 mt-auto">
            <blockquote classNameName="space-y-2">
              ...
              <footer classNameName="text-sm">Sofia Davis</footer>
            </blockquote>
          </div>
        </div>
